...
public class GuiExample {
	public static void main(String[] args) {
		...
		// ImageIcon
		ImageIcon icon = new ImageIcon("D:\\idea-workspaces\\learn-java\\src\\com\\gui\\staff_1024.jpg");
		// 图片缩放
		Image image = icon.getImage().getScaledInstance(10, 10, Image.SCALE_DEFAULT);
		Icon imageIconNew = new ImageIcon(image);
		
		ImageIcon icon2 = new ImageIcon("D:\\idea-workspaces\\learn-java\\src\\com\\gui\\true.png");
